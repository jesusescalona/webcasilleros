...
(Toda esta infomaci&oacute;n es privada y est&aacute; protegida).</div></td>
              ...
              <tr valign="baseline">
                <td align="right" nowrap class="txtTextoJ"><div align="left">Codigo
                    postal :<span class="requeridos">*</span></div></td>
                <td><div align="left">
                  <input name="cas_zip" type="text" class="txtCajas" style="margin-right:0px" value="<%=request.form("cas_zip")%>" >
				
				  
				 
                  <a href="http://visor.codigopostal.gov.co/472/visor/" target="_blank"><img src="imagenes/pregunta.jpg" alt="Que es?" width="13" height="16" border="0" /></a>
