...
If (CStr(Request("MM_update")) = "form1" And CStr(Request("MM_recordId")) <> "") Then
  ...
  MM_editRedirectUrl = ""
  MM_fieldsStr  = "cas_alias|value|cas_nombre|value|cas_empresa|value|cas_direccion|value|cas_ciudad_id|value|cas_ciudad|value|cas_zip|value|cas_telefono|value|cas_fax|value|cas_email|value|cas_password|value|cas_identificacion|value"
  MM_columnsStr = "cas_alias|',none,''|cas_nombre|',none,''|cas_empresa|',none,''|cas_direccion|',none,''|cas_ciudad_id|none,none,NULL|cas_ciudad|',none,''|cas_zip|',none,''|cas_telefono|',none,''|cas_fax|',none,''|cas_email|',none,''|cas_password|',none,''|cas_identificacion|',none,''"
...
rsCasillero.Source = "select *,ciudades.nombre as ciudad,isnull(cas_identificacion,'') as cas_identificacion from casilleros inner join ciudades on cas_ciudad_id=id_ciudad where cas_casillero_id=" + Replace(rsCasillero__tmpid, "'", "''") + ""
...
<script type="text/javascript">
  ...
  function openWin(loc, w, h) {
        var newWin = window.open(loc, "HTML", 'dependent=1,toolbar=0,location=0,directories=0,status=0, menubar=0,scrollbars=1,resizable=1,width=' + w + ',height=' + h);
        newWin.window.focus();
    }
</script>
  ...
  <table width="100%" class="titulos2">
    ...
    <tr valign="baseline">
	  ...
	  <input name="cas_ciudad_id" type="hidden" value="<%=(rsCasillero.Fields.Item("cas_ciudad_id").Value)%>">
	   <input name="cas_ciudad" readonly="readonly" disabled="disabled"  class="txtCajas" id="cas_ciudad" type="text"  value="<%=(rsCasillero.Fields.Item("ciudad").Value)%>" size="32">
        <input name="action" type="button" class="btnAccion" tabindex="15" onclick="javascript:openWin('../../app/CiudadesEditar.asp','600','350')" value="Ciudad" />
     </td>
    </tr>
	 <tr valign="baseline">
      <td align="right" nowrap class="txtTexto"><div align="left"><strong>Identificación:</strong></div></td>
      <td class="txtTexto"><input name="cas_identificacion" id="cas_identificacion" type="text" class="txtCajas" value="<%=(rsCasillero.Fields.Item("cas_identificacion").Value)%>" size="32">      </td>
    </tr>
    <tr valign="baseline">
