...
rsInformacion.Source = "select *,ciudades.nombre as ciudad,isnull(cas_identificacion,'') as cas_identificacion from casilleros inner join ciudades on cas_ciudad_id=id_ciudad where cas_casillero_id=" + Replace(rsInformacion__tmpId, "'", "''") + ""
...
function fp(URL)
{
	...
	<table width="100%" border="0" cellpadding="2" cellspacing="0" class="titulos2">
      ...
      <tr class="trs2">
        ...
        <td class="txtTexto"><div align="right"><strong>Identificación:</strong></div></td>
        <td class="txtTexto"><%=(rsInformacion.Fields.Item("cas_identificacion").Value)%></td>
      </tr>
      <tr class="trs2">
