...
<script LANGUAGE="JavaScript"> 
   ...
   { 
	...
	else if (formulario.txtPesoLibras.value<10) {r=0;alert("El Peso debe ser mínimo de 10 Libras"); formulario.txtPesoLibras.focus}
  ...
  VarSeguroI = VarImpuesto * 0.05;
  
  if (VarDimensiones/166 > VarPesoL) {VarPesoL = VarDimensiones/166 * 5}
  else {VarPesoL = VarPesoL * 5};
  
  //VarTotalImportacion = (VarPesoL + VarImpuesto + VarImpuestoI + VarSeguro + VarSeguroI);
  VarTotalImportacion = (VarPesoL + VarImpuestoI + VarSeguroI + 5);
...
<table width="800" border="0" cellspacing="0" cellpadding="0" align="center" style="background:url(Imagenes/Body.jpg)">
  ...
  <tr bgcolor="#3086BC">
	...
	<form action="procesa.phtml" method="GET" enctype="multipart/form-data" name="formulario" id="formulario">
  	...
  	<tr>
		<td colspan="4"><p align="center" class="txtTituloC"><strong>M&Eacute;XICO</strong></p>		  
		  <div align="center" class="txtTituloC"></div></td>
	</tr>
    <tr>
      ...
      <td width="145" class="style2"><span class="style3"><span class="style18">
        <input name="txtPesoLibras" type="text" id="txtPesoLibras" tabindex="2" value="10"  maxlength="10">
      </span></span></td>
