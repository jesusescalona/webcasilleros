    ...
    <td colspan="2" scope="col" height="97" valign="bottom">
      ...
      <form action="http://zaicargo.controlbox.net/webcasilleros/clientes/login.asp" method="POST" name="frmaIngreso">
        <table width="100" border="0" cellspacing="0" cellpadding="0" align="right">
          ...
          <tr>
            <td nowrap="nowrap"><a href="javascript:fp('oc.asp');">Olvido su clave?</a></td>
...
<script language="JavaScript" src="http://64.40.118.60:88/chat/js/status_image.php?base_url=http://64.40.118.60:88/chat&l=admin&x=1&deptid=1&"><a href="http://www.phplivesupport.com"></a></script>
...
<table border="1" align="center">
  <tr>
    <td colspan="2" bgcolor="#006699"><div align="center" class="style5 style1 style2"><span class="style1">SUGERENCIAS</span></div></td>
    </tr>
  
  <tr>
    <td><div align="left"><span class="style2 style1">Nombre:</span></div></td>
    <td><input name="nombre" type="Text" size="40" maxlength="200"> </td>
  </tr>
  <tr>
    <td><div align="left"><span class="style2 style1">Apellido:</span></div></td>
    <td><input name="apellido" type="Text" size="40" maxlength="200" /></td>
  </tr>
  <tr>
    <td><div align="left"><span class="style2 style1">Email:</span></div></td>
    <td><input name="email" type="text" size="40" maxlength="200" /></td>
  </tr>
  
  
  <tr>
    <td><div align="left"><span class="style2 style1">Sugerencias: </span></div></td>
