...
<script LANGUAGE="JavaScript"> 
  ...
  if (formulario.txtPesoLibras.value < 6) {VarDolarPeso = 15; VarPesoLimite = 75}
  else {VarDolarPeso = 15; VarPesoLimite = 0}
  
  if (VarDimensiones/166 > VarPesoL) {VarPesoL = VarDimensiones/166 * VarDolarPeso}
  //else {VarPesoL = VarPesoL * VarDolarPeso};
  else if (VarPesoLimite == 75) {VarPesoL = VarPesoLimite}
  else {VarPesoL = VarPesoL * VarDolarPeso};
  
  //VarTotalImportacion = (VarPesoL + VarImpuesto + VarImpuestoI + VarSeguro + VarSeguroI);
  VarTotalImportacion = (VarPesoL + VarImpuestoI + VarSeguroI);
...
<table width="800" border="0" cellspacing="0" cellpadding="0" align="center" style="background:url(Imagenes/Body.jpg)">
  ...
  </div><a href="http://www.zaicargo.com" target="_blank"><img src="Imagenes/Logo.png" alt="Zaicargo" width="205" height="60" border="0" /></a></tr>
   <tr>
  ...
  <tr bgcolor="#3086BC">
	...
	<form action="procesa.phtml" method="GET" enctype="multipart/form-data" name="formulario" id="formulario">
  	...
  	<tr>
		<td colspan="4"><p align="center" class="txtTituloC"><strong>EUROPA A ECUADOR</strong></p>		  <div align="center" class="txtTituloC"></div></td>
	</tr>
    <tr>
      <td width="67" class="style2">&nbsp;</td>
	  <td width="228" class="txtTextoBJ"><div align="left">Peso en Kilos</div></td>
    ...
    <tr>
      ...
      <td class="style2"><span class="style3"><span class="style18">
        <input name="txtImpuesto" type="text" id="txtImpuesto" tabindex="3" value="0" ReadOnly>
      </span></span></td>
      <td class="style2">&nbsp;</td>
    </tr>
    <tr>
      <td class="style2">&nbsp;</td>
      <td class="txtTextoBJ"><div align="left">Dimensiones Alto (Cm)  </div></td>
      <td class="style2"><span class="style3"><span class="style18">
        <input name="txtAlto" type="text" id="txtAlto" tabindex="3" value="0" ReadOnly>
      </span></span></td>
      <td class="style2">&nbsp;</td>
    </tr>
    <tr>
      <td class="style2">&nbsp;</td>
      <td class="style2"><div align="left"><span class="txtTextoBJ">Dimensiones Ancho (Cm)  </span></div></td>
      <td class="style2"><span class="style3"><span class="style18">
        <input name="txtAncho" type="text" id="txtAncho" tabindex="3" value="0" ReadOnly>
      </span></span></td>
      <td class="style2">&nbsp;</td>
    </tr>
    <tr>
      ...
      <td class="style2">&nbsp;</td>
	  <td class="style2"><div align="left"><span class="txtTextoBJ">Dimensiones Largo (Cm)  </span></div></td>
      <td class="style2"><span class="style3"><span class="style18">
        <input name="txtLargo" type="text" id="txtLargo" value="0" ReadOnly>
      </span></span></td>
      <td class="style2">&nbsp;</td>
    </tr>
    <tr>
      ...
      <td class="style2"><span class="style3"><span class="style18">
        <input name="txtSeguro" type="text" id="txtSeguro" value="0">
      </span></span></td>
      <td class="style2">&nbsp;</td>
    </tr>
    <tr>
