...
<script LANGUAGE="JavaScript"> 
  ...
  VarRecargoDistribucion = 0;
  
  //if (formulario.txtPesoLibras.value < 6) {VarDolarPeso = 15}
  if (formulario.txtPesoLibras.value < 11) /*{VarDolarPeso = 55; VarPesoLimite = 0; VarPesoL = VarDolarPeso}*/
  		{VarTotalImportacion = (47 + VarRecargoDistribucion);
		VarTotalImportacion = Math.round(VarTotalImportacion*100)/100;
  		formulario.txtTotalImportacion.value = VarTotalImportacion;}
  else {
  		VarDolarPeso = 4.7; VarPesoLimite = 0; VarPesoL = VarPesoL * VarDolarPeso;
...
<table width="800" border="0" cellspacing="0" cellpadding="0" align="center" style="background:url(Imagenes/Body.jpg)">
  ...
  <tr bgcolor="#3086BC">
	...
	<form action="procesa.phtml" method="GET" enctype="multipart/form-data" name="formulario" id="formulario">
  	...
  	<tr>
		<td colspan="4"><p align="center" class="txtTituloC"><strong>HONDURAS</strong></p>		  <div align="center" class="txtTituloC"></div></td>
	</tr>
    <tr>
    ...
    <tr>
      ...
      <td class="style2"><span class="style3"><span class="style18">
        <input name="txtAlto" type="text" id="txtAlto" tabindex="3" value="0" readonly="readonly" disabled="disabled">
      </span></span></td>
      <td class="style2">&nbsp;</td>
    </tr>
    <tr>
      ...
      <td class="style2"><span class="style3"><span class="style18">
        <input name="txtAncho" type="text" id="txtAncho" tabindex="3" value="0" readonly="readonly" disabled="disabled">
      </span></span></td>
      <td class="style2">&nbsp;</td>
    </tr>
    <tr>
      ...
      <td class="style2"><span class="style3"><span class="style18">
        <input name="txtLargo" type="text" id="txtLargo" value="0" readonly="readonly" disabled="disabled">
      </span></span></td>
      <td class="style2">&nbsp;</td>
    </tr>
    <tr>
