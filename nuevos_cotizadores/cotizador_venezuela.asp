...
<script LANGUAGE="JavaScript"> 
   ...
   { 
	...
	else if (formulario.txtPesoLibras.value>999) {r=0;alert("El Peso debe ser máximo de 999 Libras"); formulario.txtPesoLibras.focus}
  ...
  VarSeguroI = 0;/*VarSeguro * 0.05;*/
  
  //if (formulario.txtPesoLibras.value < 6) {VarDolarPeso = 15}
  if (formulario.txtPesoLibras.value < 6) {VarDolarPeso = 5; VarPesoLimite = 0}
  else {VarDolarPeso = 5; VarPesoLimite = 0}
...
<table width="800" border="0" cellspacing="0" cellpadding="0" align="center" style="background:url(Imagenes/Body.jpg)">
  ...
  <tr bgcolor="#3086BC">
	...
	<form action="procesa.phtml" method="GET" enctype="multipart/form-data" name="formulario" id="formulario">
  	...
  	<tr>
		<td colspan="4"><p align="center" class="txtTituloC">VENEZUELA</p>		  <div align="center" class="txtTituloC"></div></td>
	</tr>
    <tr>
