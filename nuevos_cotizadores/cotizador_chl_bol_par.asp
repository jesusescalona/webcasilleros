...
<script LANGUAGE="JavaScript"> 
   ...
   { 
	...
	else if (formulario.txtPesoLibras.value<0.01) {r=0;alert("El Peso debe ser mínimo de 0.01 Libras"); formulario.txtPesoLibras.focus}
  ...
  if (formulario.txtPesoLibras.value < 10) {VarDolarPeso = 6; VarPesoLimite = 15}
...
<table width="800" border="0" cellspacing="0" cellpadding="0" align="center" style="background:url(Imagenes/Body.jpg)">
  ...
  <tr bgcolor="#3086BC">
	...
	<form action="procesa.phtml" method="GET" enctype="multipart/form-data" name="formulario" id="formulario">
  	...
  	<tr>
		<td colspan="4"><p align="center" class="txtTituloC"><strong>CHILE - BOLIVIA - PARAGUAY</strong></p>		  <div align="center" class="txtTituloC"></div></td>
	</tr>
    <tr>
    ...
    <tr>
      ...
      <td class="style2"><span class="style3"><span class="style18">
        <input name="txtImpuesto" type="text" id="txtImpuesto" tabindex="3" value="0" readonly="readonly">
      </span></span></td>
      <td class="style2">&nbsp;</td>
    </tr>
    <tr>
      ...
      <td class="style2"><span class="style3"><span class="style18">
        <input name="txtAlto" type="text" id="txtAlto" tabindex="3" value="0" readonly="readonly">
      </span></span></td>
      <td class="style2">&nbsp;</td>
    </tr>
    <tr>
      ...
      <td class="style2"><span class="style3"><span class="style18">
        <input name="txtAncho" type="text" id="txtAncho" tabindex="3" value="0" readonly="readonly">
      </span></span></td>
      <td class="style2">&nbsp;</td>
    </tr>
    <tr>
      ...
      <td class="style2"><span class="style3"><span class="style18">
        <input name="txtLargo" type="text" id="txtLargo" value="0" readonly="readonly">
      </span></span></td>
      <td class="style2">&nbsp;</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td class="style2"><span class="style3">
        <input name="txtTotalImportacion" type="text" id="txtTotalImportacion" value="15" ReadOnly>
      </span></td>
      <td class="style2">&nbsp;</td>
    </tr>
