...
<script LANGUAGE="JavaScript"> 
   ...
   { 
	...
	else if (formulario.txtPesoLibras.value<5) {r=0;alert("El Peso debe ser mínimo de 5 Libras"); formulario.txtPesoLibras.focus}
  ...
  if (VarDimensiones/6000 > VarPesoL) {VarPesoL = VarDimensiones/6000 * VarDolarPeso}
...
<table width="800" border="0" cellspacing="0" cellpadding="0" align="center" style="background:url(Imagenes/Body.jpg)">
  ...
  <tr bgcolor="#3086BC">
	...
	<form action="procesa.phtml" method="GET" enctype="multipart/form-data" name="formulario" id="formulario">
  	...
  	<tr>
		<td colspan="4"><p align="center" class="txtTituloC"><strong>EUROPA A MEXICO</strong></p>		  <div align="center" class="txtTituloC"></div></td>
	</tr>
    <tr>
      ...
      <td width="145" class="style2"><span class="style3"><span class="style18">
        <input name="txtPesoLibras" type="text" id="txtPesoLibras" tabindex="2" value="5"  maxlength="10">
      </span></span></td>
    ...
    <tr>
      ...
      <td class="style2"><span class="style3"><span class="style18">
        <input name="txtImpuesto" type="text" id="txtImpuesto" tabindex="3" value="0">
      </span></span></td>
      <td class="style2">&nbsp;</td>
    </tr>
    <tr>
